...
//Задача 2
//Даны несколько заготовленных типов. 
//При помощи них "собран" тип Student. 
//Соберите типы Teacher и Director из имеющихся типов. 
//Для проверки используйте переменные в самом низу. Можно определять новые типы.
...
//Director имеет идентификатор, имя, словарь студентов и словарь учителей. 
//Словарь студентов по id студента содержит объект с идентификатором и именем студента.
